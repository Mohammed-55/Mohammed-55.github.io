...
if(getLanuage === "arabic"){
    ...
    sumary.innerHTML="خريج علوم الكمبيوتر ومهتم بتطوير الويب ، لدي خبرة في استخدام لغات html و css و java و javascript و sql و php. لدي أيضًا القليل من الخبرة في c # و swift ، أبحث عن دور يمكنني من خلاله النمو والتعلم من أعضاء الفريق ذوي الخبرة أثناء استخدام المهارات التي قمت بتحسينها لمساعدتهم.";
